...
// FIX: Replaced useSearchParams (v6) with useLocation (v5) to fix module export error.
...
const SearchPage: React.FC = () => {
  // FIX: useSearchParams is a v6 hook. Replaced with useLocation and URLSearchParams for v5 compatibility.
